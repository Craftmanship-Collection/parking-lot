...
public class ParkingLot {
    ...
    public static void setup() {
        ...
        System.out.println("Enter the number of free slots for two wheelers");
        freeSlotsForTwoWheeler = interaction.readInt();

        System.out.println("Enter the number of free slots for four wheelers");
        freeSlotsForFourWheeler = interaction.readInt();
    }
}
